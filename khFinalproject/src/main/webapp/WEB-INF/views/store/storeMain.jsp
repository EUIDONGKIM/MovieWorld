...
<div class="row">
				<c:choose>
					<c:when test="${storePhotoDto == null}">
					<img src="https://via.placeholder.com/500x500?text=image" width="100%" class="image image-round image-border">
					</c:when>
					<c:otherwise>
					<img src="photo?productPhotoNo=${storePhotoDto.productPhotoNo}" width="100%" class="image image-round image-border">
					</c:otherwise>
				</c:choose>
